...
public class MybatisDemo {
    ...
    @Test
    public void getMapEmployeeByLikeLastName(){
...
//            System.out.println(employee);
    ...
    @Test
    public void getEmployeeByIdAssco1(){

        MybatisDemo mybatisDemo = new MybatisDemo();
        SqlSession session = mybatisDemo.sqlSessionFactory.openSession();
        EmployeeMapping mapper = session.getMapper(EmployeeMapping.class);
        Employee employeeByOneAssoc = mapper.getEmployeeByOneAssoc1(1);
        System.out.println(employeeByOneAssoc);
        System.out.println(employeeByOneAssoc.getDept());
        session.close();

    }

    @Test
    public void getEmployeeByIdAssco2(){

        MybatisDemo mybatisDemo = new MybatisDemo();
        SqlSession session = mybatisDemo.sqlSessionFactory.openSession();
        long start = System.currentTimeMillis();
        EmployeeMapping mapper = session.getMapper(EmployeeMapping.class);
        Employee employeeByOneAssoc = mapper.getEmployeeByOneAssoc2(1);
        long over = System.currentTimeMillis();
        System.out.println("时间差："+(over-start));
        System.out.println(employeeByOneAssoc);
        System.out.println(employeeByOneAssoc.getDept());
        session.close();
    ...
    @Test
    public void getEmployeeByIdAssco3(){

        MybatisDemo mybatisDemo = new MybatisDemo();
        SqlSession session = mybatisDemo.sqlSessionFactory.openSession();
        EmployeeMapping mapper = session.getMapper(EmployeeMapping.class);
        Employee employeeByOneAssoc = mapper.getEmployeeByOneAssoc3(1);
        System.out.println(employeeByOneAssoc);
        System.out.println(employeeByOneAssoc.getDept());
        session.close();
